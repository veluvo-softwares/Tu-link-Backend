...
- `CLERK_SECRET_KEY` - Clerk secret key for the dashboard/operator backend
- `NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY` - Clerk publishable key used by both the Next.js dashboard and the API auth guard
- `CLERK_AUTHORIZED_PARTIES` - Comma-separated list of allowed frontend origins for Clerk session tokens
